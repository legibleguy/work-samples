...
* Custom fork of Unreal Engine 4.27
* Gameplay Abilities, Replication, AI with Behavior Trees
* Working around an existing legacy codebase - introducing new features without breaking existing logic
